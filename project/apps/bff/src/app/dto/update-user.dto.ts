...
import { AUTH_USER_DATEBIRTH_NOT_VALID, AUTH_USER_INFO_LENGTH, AUTH_USER_MAX_SPECIALIZATION_NUMBER, AUTH_USER_NAME_LENGTH, MAX_USER_INFO, MAX_USER_LENGTH, MAX_USER_SPECIALIZATION_NUMBER, MIN_USER_LENGTH } from '../bff.constant';
